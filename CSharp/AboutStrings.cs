...
broken line";
        ...
        public void ACrossPlatformWayToHandleLineEndings()
        {
            ...
            var vebatimString = literalString;
        ...
        public void PlusEqualsWillModifyTheTargetString()
        {
            ...
            var strB = "World";
            strA += strB;
            Assert.Equal(strA += strB, strA);
            Assert.Equal(strB , strB);
        }
		...
		public void AnyExpressionCanBeUsedInFormatString()
		{
			...
			Assert.Equal(String.Format("The square root of 9 is {0}", 3), str);
		}
		...
		public void StringsCanBePaddedToTheLeft()
		{
			...
			Assert.Equal(string.Format("{0,3:}", "x"), str);
		}
		...
		public void SeperatorsCanBeAdded()
		{
			...
			Assert.Equal(string.Format("{0:n}", 123456), str);
		}
		...
		public void NumberOfDisplayedDecimalsCanBeControled()
		{
			...
			Assert.Equal(string.Format("{0:.##}", 12.3456), str);
		}
		...
		public void MinimumNumberOfDisplayedDecimalsCanBeControled()
		{
			...
			Assert.Equal(string.Format("{0:.00}", 12.3), str);
		}
		...
		public void BuiltInDateFormaters()
		{
			...
			Assert.Equal(string.Format("{0:t}", DateTime.Parse("12/16/2011 2:35:02 PM")), str);
		}
		...
		public void CustomeDateFormaters()
		{
			...
			Assert.Equal(string.Format("{0:t m}", DateTime.Parse("12/16/2011 2:35:02 PM")), str);
		}
        ...
        public void ABetterWayToConcatenateLotsOfStrings()
        {
            ...
            Assert.Equal(strBuilder.ToString(), str);
